# Akamai Cloud Marketplace Apps

This repository contains the deployment scripts and Ansible playbooks for two Akamai Cloud Marketplace apps that I developed and published: **JupyterLab** and **InfluxDB**. These apps have been submitted as pull requests to the official Akamai Cloud Marketplace project, have been merged, and are now fully deployable on Akamai Cloud.
...
## Usage
To deploy these apps on Akamai Cloud:
...
5. **Deploy**: Once configured, initiate the deployment, and your app will be up and running on Akamai Cloud.

For more detailed guidance, refer to the following deployment guides:
- **Deploy JupyterLab** through the Akamai Marketplace: [JupyterLab Guide](https://www.linode.com/docs/marketplace-docs/guides/jupyterlab/)
- **Deploy InfluxDB** through the Akamai Marketplace: [InfluxDB Guide](https://www.linode.com/docs/marketplace-docs/guides/influxdb/)

## Contributions
Those looking to contribute directly to the Akamai Cloud Marketplace should review the [Contribution Guide](https://github.com/akamai-compute-marketplace/marketplace-apps/blob/main/docs/CONTRIBUTING.md).

## License
These applications are subject to the Akamai Cloud Marketplace license. Please review the license [here](https://github.com/akamai-compute-marketplace/marketplace-apps/blob/main/LICENSE) for more information.
